...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Social Profile', 'wayup' ),
		'id'               => 'social-profiles',
		'subsection'       => true,
...
Redux::set_section(
	...
	array(
      ...
      array(
				'id'       => 'header-start',
				'type'     => 'section',
				'title'    => esc_html__( 'Header Section', 'wayup' ),
      ...
      array(
				'id'       => 'footer-start',
				'type'     => 'section',
				'title'    => esc_html__( 'Footer Section', 'wayup' ),
				'indent'   => true, // Indent all options below until the next 'section' option is set.
			),
      array(
				'id'       => 'footer_address',
				'type'     => 'text',
				'title'    => esc_html__( 'Address', 'wayup' ),
				'default'  => '',
			),
      array(
				'id'       => 'footer_phone',
      ...
      array(
				...
				'type'    => 'editor',
				'title'   => esc_html__( 'Copirights', 'wayup' ),
				'default' => '©2007-2022 All rights reserved',
				'args'    => array(
					'wpautop'       => false,
					'media_buttons' => false,
					'textarea_rows' => 5,
...
Redux::set_section(
	...
	array(
		...
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( ' Add Media filse and data for Home Header ', 'wayup' ),
		'fields'           => array(
      array(
				'id'           => 'header_bg',
				'type'         => 'media',
				'url'          => true,
				'title'        => esc_html__( 'Background for slider', 'wayup' ),
				'compiler'     => 'true',
				'desc'         => esc_html__( 'Recomended size 1920px-998px', 'wayup' ),
				'preview_size' => 'full',
      ...
      array(
        ...
        'hint'     => array(
					'title'   => 'Link from YouTube',
					'content' => 'Use a simple link from the browser line to the video from YouTube',
				),
			),
      array(
      ...
      array(
				...
				'type'        => 'slides',
				'title'       => esc_html__( 'Slides Options', 'wayup' ),
				'subtitle'    => esc_html__( 'Unlimited slides with drag and drop sortings.', 'wayup' ),
				'desc'        => esc_html__( 'This field will store all slides values into a multidimensional array to use into a foreach loop.', 'wayup' ),
				'placeholder' => array(
					'title'       => esc_html__( 'This is a title', 'wayup' ),
					'description' => esc_html__( 'Description Here', 'wayup' ),
					'url'         => esc_html__( 'Give us a link!', 'wayup' ),
				),
			),
		),
	)
