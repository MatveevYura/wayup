      ...
      <div class="wrapper">
        <div class="offer__slider">
          ...
          <div class="offer__slide">
            ...
            <a href="<?php echo $slide['url']; ?>" class="offer__btn btn popup-link"><?php esc_html_e('Free consultation', 'wayup') ?></a>
          </div>

        <?php } ?>
        </div>
        <?php if($wayup_options['header_video']) { ?>
          <a class="offer__video popup-with-zoom-anim popup-youtube" href="<?php echo $wayup_options['header_video']?>"
            rel="nofollow">
